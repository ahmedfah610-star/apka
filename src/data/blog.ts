...
export const ARTYKULY: Artykul[] = [
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Dobrze skompletowana wiosenna szafa to zestaw warstw, które dowolnie łączysz: kilka koszulek, bluzy, [dresy dziecięce](/kolekcje/dresy-dzieciece) i jedna dobra kurtka przejściowa. Z takim zestawem ubierzesz dziecko na każdą wiosenną niespodziankę." },
    ],
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Dobra zasada: tyle [kompletów dziecięcych](/kolekcje/komplety-dzieciece), ile dni wyjazdu, plus 2–3 zapasowe na nieuniknione plamy i przebranie. Jeśli masz dostęp do pralki, śmiało pakuj mniej — dzieci brudzą ubrania szybciej, niż zdążysz je zmieniać, więc możliwość prania to Twój sprzymierzeniec." },
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Latem wybieraj cienkie piżamki z krótkim rękawem lub lekkie [body do spania](/kolekcje/body-dzieciece); zimą — grubsze, z długim rękawem i nogawkami, albo [pajacyki i śpioszki](/kolekcje/pajacyki-i-spiochy-niemowlece) dla najmłodszych. Pamiętaj o temperaturze w pokoju: dla dziecka zalecane jest 18–20°C, a piżamę i ewentualny śpiworek dobierz do niej, żeby maluch się nie przegrzał." },
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        ...
        "przewiewne [sukienki dla dziewczynki](/kolekcje/sukienki-dla-dziewczynki), luźne spodenki i lekkie komplety,",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        ...
        "[dresy dziecięce](/kolekcje/dresy-dzieciece), legginsy i dzianinowe komplety,",
        "ciepły sweter lub bluza,",
        "kombinezon zimowy lub kurtka ze spodniami,",
        "[czapka dziecięca](/kolekcje/czapki-dzieciece) zakrywająca uszy i komin zamiast szalika (bezpieczniejszy),",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        "2–3 [body z długim rękawem](/kolekcje/body-niemowlece) (rozmiar 56, a jedno 62 na wszelki wypadek),",
        "2–3 [pajacyki zapinane na zatrzaski](/kolekcje/pajacyki-i-spiochy-niemowlece),",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Tu dziecko coraz częściej raczkuje i chodzi, więc stawiaj na wygodne, wytrzymałe [komplety dziecięce](/kolekcje/komplety-dzieciece) i [dresy](/kolekcje/dresy-dzieciece) z gumką w pasie. Body wciąż się przydają jako warstwa spodnia. Zwykle wystarcza kilka kompletów na co dzień, 2–3 pary spodni, kilka koszulek/body i cieplejsza warstwa dobrana do sezonu." },
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        "[sukienka dla dziewczynki](/kolekcje/sukienki-dla-dziewczynki) lub elegancki komplet w bieli albo pastelach,",
      ...
      { typ: "ul", punkty: [
        "elegancki [komplet dla chłopca](/kolekcje/komplety-dla-chlopca): body-koszula plus spodenki lub sweterek,",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Nawet przy dobrze zmierzonym dziecku zdarza się, że coś nie pasuje. Dlatego przed zakupem sprawdź politykę zwrotów sklepu — ile masz dni i czy zwrot jest wygodny. U nas masz [14 dni na zwrot](/dostawa-i-zwroty) bez podawania przyczyny, więc dobór rozmiaru online przestaje być loterią." },
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        "[pajacyki i śpioszki](/kolekcje/pajacyki-i-spiochy-niemowlece) zapinane na zatrzaski (rozmiar 68–80),",
        "[body z długim rękawem](/kolekcje/body-niemowlece) — podstawa każdej szafy niemowlaka,",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Dobrze skompletowana jesienna szafa to zestaw warstw, które można dowolnie łączyć: kilka koszulek, bluzy, [dresy dziecięce](/kolekcje/dresy-dzieciece) i jedna dobra kurtka przejściowa. Z takim zestawem ubierzesz dziecko na każdą jesienną niespodziankę pogodową." },
    ],
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        ...
        "[dresy dziecięce](/kolekcje/dresy-dzieciece), legginsy i body, które łączysz na wiele sposobów,",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "p", tekst: "Nie musisz być ekspertem, żeby czytać metki. Wystarczy zapamiętać kilka rzeczy: szukaj bawełny i certyfikatu OEKO-TEX, sprawdzaj temperaturę prania i omijaj sznurki przy szyi. Tyle wystarczy, by wybierać [ubranka dla dziecka](/produkty) bezpieczne, wygodne i trwałe." },
    ],
  },
  {
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "ul", punkty: [
        "[body z długim rękawem](/kolekcje/body-niemowlece) — 5–7 szt.",
        "body z krótkim rękawem — 3–4 szt. (na cieplejsze dni i pod ubranka)",
        "[pajacyki / śpiochy](/kolekcje/pajacyki-i-spiochy-niemowlece) zapinane na zatrzaski — 4–6 szt.",
  ...
  },
  {
    ...
    tresc: [
      ...
      { typ: "h2", tekst: "Zima" },
      { typ: "ul", punkty: [
        "warstwa bazowa: [body z długim rękawem](/kolekcje/body-niemowlece) przy skórze,",
        "warstwa środkowa: dres lub [komplet dzianinowy](/kolekcje/komplety-niemowlece),",
